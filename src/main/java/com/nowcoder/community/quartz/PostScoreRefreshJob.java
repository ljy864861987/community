...
public class PostScoreRefreshJob implements Job, CommunityConstant {
	...
	private void refresh(int postId) {
		DiscussPost post = discussPostsService.finfDiscussPostById(postId);
		...
		// 点赞数量
		long likeCount = likeService.findElementLikeCount(ENTITY_TYPE_POST, postId);
		...
		// 更新帖子分数
		discussPostsService.updateScore(postId, score);
		// 更新搜索数据
		post.setScore(score);
