...
public class ElasticsearchTests {
	...
	public void testInsert() {
		...
		discussPostRepository.save(discussPostMapper.selectDiscussPostById(240));
	...
	public void testUpdate() {
		DiscussPost posts = discussPostMapper.selectDiscussPostById(231);
		posts.setContent("我是新人，使劲灌水");
		discussPostRepository.save(posts);
	}
